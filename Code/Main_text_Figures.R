...
Coefficients <- rev(c(fit_1_1$coefficients[2]/sd(Study_1_Data$Susc_FN),
...
CI_Upper <- rev(c(CI_1_1[2,2]/sd(Study_1_Data$Susc_FN),
...
CI_Lower <- rev(c(CI_1_1[2,1]/sd(Study_1_Data$Susc_FN),
...
#Save figure:
ggsave('./Figures/All_4_Studies.png',height=6,width=8)
...
#Save figure:
ggsave('./Figures/Study_5_Bar_Graph_Google_Search.png',height=8,width=12)
